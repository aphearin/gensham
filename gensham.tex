...
\eeq
where $\Ngal(>\mstar)$ is the observed cumulative stellar mass function. Introducing stochasticity between $\mstar$ and $\mpeak$ can be accomplished by the iterative deconvolution method described in \citet{behroozi10} or \citet{kravtsov13}. 
